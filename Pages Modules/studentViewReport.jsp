...
<div style="margin-left: 24%; margin-top: 20px;">
  ...
  <div class="card-header">Report for Previous Test</div>
  <div class="card-body">
    <h4 class="card-title">Previous Test Report</h4>
    <p class="card-text">This part would display the previous test details of a student.</p>
